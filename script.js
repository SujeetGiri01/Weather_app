// api key from TMDB
const api = "api_key=067f5342d18236f809ca79606921557d";
//base url of the site
const base_url= "https://api.themoviedb.org/3";

const banner_url= "https://image.tmdb.org/t/p/original";
const img_url= "https://image.tmdb.org/t/p/w500"; //YOU CAN CHANGE "w185" 
...
const requests ={
    ...
    fetchRomanceMovies: `${base_url}/discover/movie?${api}&with_genres10749`,
...
fetch(requests.fetchNetflixOriginals)
    ...
    fetch(requests.fetchNetflixOriginals)
        ...
        .then((data)=>{
            ...
            row.appendChild(title);
            const row_posters = document.createElement("div");
            row_posters.className = "row_poster";
            row.appendChild(row_posters);
